...
var uri = "mongodb+srv://".concat(process.env.DB_USERNAME, ":").concat(process.env.DB_PASSWORD, "@tweetprojectk18f2.wdljj7x.mongodb.net/?retryWrites=true&w=majority");
...
var DatabaseService = /** @class */ (function () {
    ...
    Object.defineProperty(DatabaseService.prototype, "refreshTokens", {
        //*tạo thêm 1 table có tên là refresh_token
        get: function () {
            return this.db.collection(process.env.DB_REFRESH_TOKENS_COLLECTTION);
        },
        enumerable: false,
        configurable: true
    });
